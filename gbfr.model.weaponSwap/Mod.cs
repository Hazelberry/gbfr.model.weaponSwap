...
using gbfr.model.weaponSwap.Configuration;
using gbfr.model.weaponSwap.Template;
...
namespace gbfr.model.weaponSwap;
...
public class Mod : ModBase // <= Do not Remove.
{
    ...
    public void ApplyModelSwap()
    {
        ...
        ProcessModels(weaponIdList); // Direct model swap, incompatible with modded weapons
